    ...
    <nav className="mt-4 bg-[17, 23, 41]">
      <div className="flex flex-col 2xl:flex-row justify-between items-center">
        ...
        <div className="flex flex-col 2xl:flex-row 2xl:w-2/3 items-center justify-center text-gray-100">
          ...
          {props.isAdmin && (
            <button className={`flex flex-row items-center mb-3 2xl:mb-0 2xl:mx-4 px-3 text-2xl uppercase ${props.tab === "runners" && "text-blue-400 border-b border-solid border-blue-400"}`} onClick={() => props.setTab("runners")}>
          ...
          <button className={`flex flex-row items-center mb-3 2xl:mb-0 2xl:mr-4 px-3 text-2xl uppercase ${props.tab === "transactions" && "text-blue-400 border-b border-solid border-blue-400"}`} onClick={() => props.setTab("transactions")}>
          ...
          {props.isAdmin && (
            <>
              <button className={`flex flex-row items-center mb-3 2xl:mb-0 2xl:mr-4 px-3 text-2xl uppercase ${props.tab === "bookies" && "text-blue-400 border-b border-solid border-blue-400"}`} onClick={() => props.setTab("bookies")}>
                <FontAwesomeIcon icon={faBook} width={20} className="mr-2" />
                <div>
                  Bookies
                </div>
              </button>
              <button className={`flex flex-row items-center px-3 text-2xl uppercase ${props.tab === "agents" && "text-blue-400 border-b border-solid border-blue-400"}`} onClick={() => props.setTab("agents")}>
